...
if [ -e $DIR/DailyAdvisor-API ] ;then
    ...
    git clone https://github.com/code-pride/DailyAdvisor-API.git $DIR/DailyAdvisor-API
...
if [ -e $DIR/UserService-micro ] ;then
    ...
    git clone https://github.com/code-pride/UserService.git $DIR/UserService-micro
...
if [ -e $DIR/EurekaDiscovery ] ;then
    ...
    git clone https://github.com/code-pride/EurekaDiscovery.git $DIR/EurekaDiscovery
...
if [ -e $DIR/ZuulGateway ] ;then
    ...
    git clone https://github.com/code-pride/ZuulGateway.git $DIR/ZuulGateway
